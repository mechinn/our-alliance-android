 ...
 */
public class Team extends com.mechinn.android.ouralliance.OurAllianceObject  implements Comparable<Team> {
    ...
    private List<EventTeam2014> events;
    ...
    public List<EventTeam2014> getEvents() {
        if (events == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            EventTeam2014Dao targetDao = daoSession.getEventTeam2014Dao();
            List<EventTeam2014> eventsNew = targetDao._queryTeam_Events(id);
            synchronized (this) {
                if(events == null) {
                    events = eventsNew;
                }
