...
/** 
 * DAO for table MATCH2014.
*/
public class Match2014Dao extends AbstractDao<Match2014, Long> {

    public static final String TABLENAME = "MATCH2014";

    /**
     * Properties of entity Match2014.<br/>
    ...
    */
    ...
    private Query<Match2014> event2014_MatchesQuery;

    public Match2014Dao(DaoConfig config) {
        super(config);
    }
    
    public Match2014Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'MATCH2014' (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_MATCH2014_EVENT_ID_MATCH_NUM ON MATCH2014" +
                " (EVENT_ID,MATCH_NUM);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'MATCH2014'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Match2014 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Match2014 entity) {
    ...
    /** @inheritdoc */
    @Override
    public Match2014 readEntity(Cursor cursor, int offset) {
        Match2014 entity = new Match2014( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Match2014 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Match2014 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Match2014 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    /** Internal query to resolve the "matches" to-many relationship of Event2014. */
    public List<Match2014> _queryEvent2014_Matches(Long eventId) {
        synchronized (this) {
            if (event2014_MatchesQuery == null) {
                QueryBuilder<Match2014> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.EventId.eq(null));
                queryBuilder.orderRaw("MATCH_NUM ASC");
                event2014_MatchesQuery = queryBuilder.build();
            }
        }
        Query<Match2014> query = event2014_MatchesQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM MATCH2014 T");
    ...
    protected Match2014 loadCurrentDeep(Cursor cursor, boolean lock) {
        Match2014 entity = loadCurrent(cursor, 0, lock);
    ...
    public Match2014 loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Match2014> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Match2014> list = new ArrayList<Match2014>(count);
    ...
    protected List<Match2014> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Match2014> queryDeep(String where, String... selectionArg) {
