...
public class TeamScouting2014 extends com.mechinn.android.ouralliance.OurAllianceObject  implements Comparable<TeamScouting2014> {
    ...
    public List<Wheel2014> getWheels() {
        if (wheels == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            Wheel2014Dao targetDao = daoSession.getWheel2014Dao();
            List<Wheel2014> wheelsNew = targetDao._queryTeamScouting2014_Wheels(id);
            synchronized (this) {
                if(wheels == null) {
                    wheels = wheelsNew;
                }
