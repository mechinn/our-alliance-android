...
public class WheelDao extends AbstractDao<Wheel, Long> {
    ...
    */
    ...
    private Query<Wheel> teamScouting2014_WheelsQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_WHEEL_TEAM_ID_WHEEL_TYPE ON WHEEL" +
                " (TEAM_ID,WHEEL_TYPE);");
    }
    ...
    public List<Wheel> _queryTeamScouting2014_Wheels(long teamId) {
        synchronized (this) {
        ...
        Query<Wheel> query = teamScouting2014_WheelsQuery.forCurrentThread();
