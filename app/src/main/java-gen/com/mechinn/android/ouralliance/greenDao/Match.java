...
public class Match extends com.mechinn.android.ouralliance.data.OurAllianceObject  implements Comparable<Match>, java.io.Serializable {
    ...
    private List<MatchScouting2014> teams2014;
    ...
    public List<MatchScouting2014> getTeams2014() {
        if (teams2014 == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            MatchScouting2014Dao targetDao = daoSession.getMatchScouting2014Dao();
            List<MatchScouting2014> teams2014New = targetDao._queryMatch_Teams2014(id);
            synchronized (this) {
                if(teams2014 == null) {
                    teams2014 = teams2014New;
                }
            }
        }
        return teams2014;
    ...
    public synchronized void resetTeams2014() {
        teams2014 = null;
    }
