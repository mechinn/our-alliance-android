...
// KEEP INCLUDES END
/**
 * Entity mapped to table WHEEL2014.
 */
public class Wheel2014 extends com.mechinn.android.ouralliance.OurAllianceObject  implements Comparable<Wheel2014> {
    ...
    private transient Wheel2014Dao myDao;
    ...
    public Wheel2014(Long id) {
        this.id = id;
    }

    public Wheel2014(Long id, java.util.Date modified, long teamId, String wheelType, double wheelSize, int wheelCount) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getWheel2014Dao() : null;
    }
    ...
    public boolean equals(Object data) {
        if(!(data instanceof Wheel2014)) {
            return false;
        }
        return  getTeamScouting2014().equals(((Wheel2014)data).getTeamScouting2014()) &&
                getWheelType().equals(((Wheel2014)data).getWheelType()) &&
                getWheelSize()==((Wheel2014)data).getWheelSize() &&
                getWheelCount()==((Wheel2014)data).getWheelCount();
    }
    public int compareTo(Wheel2014 another) {
