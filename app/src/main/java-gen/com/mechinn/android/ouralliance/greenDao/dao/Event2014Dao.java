...
/** 
 * DAO for table EVENT2014.
*/
public class Event2014Dao extends AbstractDao<Event2014, Long> {

    public static final String TABLENAME = "EVENT2014";

    /**
     * Properties of entity Event2014.<br/>
    ...
    */
    ...
    public Event2014Dao(DaoConfig config) {
        super(config);
    }
    
    public Event2014Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'EVENT2014' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'EVENT2014'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Event2014 entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Event2014 entity) {
    ...
    /** @inheritdoc */
    @Override
    public Event2014 readEntity(Cursor cursor, int offset) {
        Event2014 entity = new Event2014( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Event2014 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Event2014 entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Event2014 entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
