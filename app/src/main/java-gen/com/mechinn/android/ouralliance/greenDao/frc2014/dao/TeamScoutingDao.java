...
/** 
 * DAO for table TEAM_SCOUTING.
*/
public class TeamScoutingDao extends AbstractDao<TeamScouting, Long> {

    public static final String TABLENAME = "TEAM_SCOUTING";

    /**
     * Properties of entity TeamScouting.<br/>
    ...
    */
    ...
    public TeamScoutingDao(DaoConfig config) {
        super(config);
    }
    
    public TeamScoutingDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TEAM_SCOUTING'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TeamScouting entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(TeamScouting entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TeamScouting entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TeamScouting entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM TEAM_SCOUTING T");
            builder.append(" LEFT JOIN TEAM T0 ON T.'TEAM'=T0.'_id'");
            builder.append(' ');
    ...
    protected TeamScouting loadCurrentDeep(Cursor cursor, boolean lock) {
        TeamScouting entity = loadCurrent(cursor, 0, lock);
    ...
    public TeamScouting loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<TeamScouting> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<TeamScouting> list = new ArrayList<TeamScouting>(count);
    ...
    protected List<TeamScouting> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<TeamScouting> queryDeep(String where, String... selectionArg) {
