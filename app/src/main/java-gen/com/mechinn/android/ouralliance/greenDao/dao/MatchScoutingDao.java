...
import com.mechinn.android.ouralliance.greenDao.MatchScouting;
...
public class MatchScoutingDao extends AbstractDao<MatchScouting, Long> {
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_MATCH_SCOUTING_MATCH_ID_TEAM_ID ON MATCH_SCOUTING" +
                " (MATCH_ID,TEAM_ID);");
    }
    ...
    public List<MatchScouting> _queryMatch_Teams(long matchId) {
        synchronized (this) {
    ...
    public List<MatchScouting> _queryTeamScouting_Matches(long teamId) {
        synchronized (this) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN TEAM_SCOUTING T1 ON T.'TEAM_ID'=T1.'_id'");
            builder.append(' ');
