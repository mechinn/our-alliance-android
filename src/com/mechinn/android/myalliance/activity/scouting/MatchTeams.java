...
import com.mechinn.android.myalliance.FragActivity;
import com.mechinn.android.myalliance.R;
import com.mechinn.android.myalliance.activity.MatchList;
...
public class MatchTeams extends ListFragment {
    ...
    void showTeam(int index) {
        ...
        if (mDualPane) {
            ...
            intent.putExtra("fragment", "com.mechinn.android.myalliance.activity.scouting.MatchTeamInfo");
    ...
    private class getMatches extends AsyncTask<Void,Void,Void> {    	
    	protected void onPostExecute(Void no) {
	        ...
	        header.setText("Match: "+Integer.toString(matchNum)+" | Time: "+Integer.toString(time));
	        header.setTextAppearance(activity, android.R.style.TextAppearance_Large);
