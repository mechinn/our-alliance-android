    ...
    */
    ...
    private Bitmap processBitmap(String data) {
        ...
        if(!data.startsWith("file://")) {
    		...
    		String type = URLConnection.guessContentTypeFromName(data);
            if(type.startsWith("image")) {
    			Log.d(TAG, "creating image thumbnail for: "+data);
                bitmap = decodeSampledBitmapFromFile(data, mImageWidth, mImageHeight);
    		} else if(type.startsWith("video")) {
    			Log.d(TAG, "creating video thumbnail for: "+data);
