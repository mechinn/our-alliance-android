...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {
            horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_flow_horizontalSpacing, 0);
            verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_flow_verticalSpacing, 0);
            orientation = a.getInteger(R.styleable.FlowLayout_flow_orientation, HORIZONTAL);
            debugDraw = a.getBoolean(R.styleable.FlowLayout_flow_debugDraw, false);
        } finally {
            a.recycle();
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            ...
            try {
                horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_flow_layout_horizontalSpacing, NO_SPACING);
                verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_flow_layout_verticalSpacing, NO_SPACING);
                newLine = a.getBoolean(R.styleable.FlowLayout_LayoutParams_flow_layout_newLine, false);
            } finally {
                a.recycle();
            }
        }
