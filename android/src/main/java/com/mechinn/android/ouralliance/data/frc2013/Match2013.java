...
public class Match2013 extends Match {
	private static final long serialVersionUID = -3255822533528181976L;
	public static final String TAG = Match2013.class.getSimpleName();
	public static final String TABLE = Match.TABLE+"2013";
	public static final String[] ALLCOLUMNS2013 = {  };
	public static final String[] ALLCOLUMNS = ArrayUtils.addAll(Match2013.ALLCOLUMNS, ALLCOLUMNS2013);
	...
	public Match2013(Competition competition, int number, Team red1, Team red2, Team red3, Team blue1, Team blue2, Team blue3, int type) {
		super(competition, number, red1, red2, red3, blue1, blue2, blue3, type);
	}
	public Match2013(Competition competition, int number, Team red1, Team red2, Team red3, Team blue1, Team blue2, Team blue3, int type, int set, int of) {
		super(competition, number, red1, red2, red3, blue1, blue2, blue3, type, set, of);
	}
	public Match2013(Competition competition, Team red1, Team red2, Team red3, Team blue1, Team blue2, Team blue3, int redScore, int blueScore, int type, int set, int of) {
		super(competition, red1, red2, red3, blue1, blue2, blue3, redScore, blueScore, type, type, of);
	}
	public Match2013(long id, Date mod, Competition competition, int number, Team red1, Team red2, Team red3, Team blue1, Team blue2, Team blue3, int redScore, int blueScore, int type, int set, int of) {
		super(id, mod, competition, number, red1, red2, red3, blue1, blue2, blue3, redScore, blueScore, type, type, of);
	}
	private void setData() {
		
	}
	public boolean equals(Match2013 data) {
	...
	public static Match2013 newFromCursor(Cursor cursor) {
		Match2013 data = new Match2013();
